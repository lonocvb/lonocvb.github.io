  ...
  constructor() {
    ...
    this.exhibits = [
      ...
      },
      {
        ...
        describe: '',
        describe2: [
          {key: 'Object Place', value: 'Florence, Italy'},
          {key: 'MEDIUM/TECHNIQUE', value: 'Marble'},
          {key: 'DIMENSIONS', value: '71.12 x 52.07 x 33.02 cm'},
          {key: 'CREDIT LINE', value: 'Gift of Mrs. Thomas O. Richardson'},
          {key: 'ON VIEW', value: 'Penny and Jeff Vinik Gallery (Gallery 233)'},
          {key: 'COLLECTIONS', value: 'Americas'},
          {key: 'CLASSIFICATIONS', value: 'Sculpture'},
        ],
      },
      {
        name: 'faith',
        ...
        describe2: [
          {key: 'Object Place', value: 'Florence, Italy'},
          {key: 'MEDIUM/TECHNIQUE', value: 'Marble'},
          {key: 'DIMENSIONS', value: '68.6 x 52.1 x 33 cm'},
          {key: 'CREDIT LINE', value: 'Gift of Mrs. Henry Lyman'},
          {key: 'ON VIEW', value: 'Penny and Jeff Vinik Gallery (Gallery 233)'},
          {key: 'COLLECTIONS', value: 'Americas'},
          {key: 'CLASSIFICATIONS', value: 'Sculpture'},
        ],
